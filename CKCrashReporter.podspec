#
# Be sure to run `pod spec lint CKCrashReporter.podspec' to ensure this is a
# valid spec and remove all comments before submitting the spec.
#
# To learn more about the attributes see http://docs.cocoapods.org/specification.html
#
Pod::Spec.new do |s|
  s.name         = "CKCrashReporter"
  s.version      = "0.0.1"
...
CKCrashReporter is a very easy to use crash reporter class for your iOS application. It was designed to be easily extendable. (More information on this can be found under #3). CKCrashReporter will catch any uncaught NSException and save useful information about it on disk. The next time the user starts the application you can read out that information and e.g. send a mail wit it via MFMailComposeViewController. If you need a more complex component KSCrash should be your first choice!
                    DESC
  s.homepage     = "https://github.com/maltzsama/CKCrashReporter"
  ...
  #s.author       = { "Demetrius Albuquerque" => "demetrius.albuquerque@yahoo.com.br" }
   s.authors      = { "Giulio Petek" => "gi-lo@touch-mania.com" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Demetrius Albuquerque', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/maltzsama/CKCrashReporter.git", :tag => "0.0.1" }
  ...
  #
  s.source_files = 'Classes', 'Classes/CKCrashReporter/*.{h,m}'
  s.exclude_files = 'Classes/CKCrashReporterDemo'
